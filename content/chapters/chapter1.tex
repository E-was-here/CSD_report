...
reduce complexity and mitigate the effects of noise and friction variations. By making reasonable assumptions, the 
transfer function is linearized and approximated to match the expected form of a first-order system transfer function, 
which is already known as:
